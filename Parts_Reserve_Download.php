<?php
	...
	$XML = "#,Kit,MSN,DWG,SN,Vendor,Work Pack,Prod#PN,Desc,MFR,IDENT,Qty Req,Qty Avl,UOM,Loc,Bin,Kit MPN\n";
	$file ="Available_Parts_Report_" . date("Y-m-d"). ".csv";

	$ROWNUM = 1;

	GetPartsForReserveDownload($MSN, $KIT, $DWG, $VEN, $PN, $SN, $LOC, $BIN, $WP, $PROD, $result);
