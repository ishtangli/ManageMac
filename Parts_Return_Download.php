<?php
	...
	$XML = "Trans#,Issued To,Task Card,Kit,MSN,DWG,SN,Vendor,Work Pack,PN,Desc,MFR,IDENT,Qty Issued,UOM,From Loc,Kit MPN\n";
	$file ="Issued_Parts_Report_" . date("Y-m-d"). ".csv";

	GetPartsForReturnDownload($MSN, $KIT, $DWG, $VEN, $PN, $SN, $TRN, $WP, $result);
	...
	while ($ResultData = mysqli_fetch_assoc($result)) {
		...
		$XML.= "\"" . str_replace("\"", "\"\"", number_format($ResultData["INVH_QTY"] - $ResultData["INVH_RETURN_QTY"], 2)) . "\",";
