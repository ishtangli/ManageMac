	...
	<table border="1" width="1024">
		...
		<tr>
			<td valign="top">
				...
				<form method="get" action="Parts_History_KIT_iFrames.php">
					...
					<input type="button" value="Reset Selection" onClick="window.location='Parts_History_KIT_iFrames.php?BY=KIT';" style="width='200';">
				...
				<iframe id="PartsFrame" src="Parts_History_KIT.php?MSN=<?php echo $MSN; ?>&KIT=<?php echo $KIT; ?>&DWG=<?php echo $DWG; ?>&VEN=<?php echo $VEN; ?>&PN=<?php echo $PN; ?>&SN=<?php echo $SN; ?>" border='0' frameborder='0' scrolling='auto' width="100%" height="440"></iframe>
			</td>
		</tr>
	</table>
