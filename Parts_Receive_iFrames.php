<?php
	...
	$STA = (isset($_GET["STA"])) ? trim($_GET["STA"]) : "OPEN";
	$WP = (isset($_GET["WP"])) ? trim($_GET["WP"]) : "";

	$LINKVARS = "MSN=" . $MSN . "&KIT=" . $KIT . "&DWG=" . $DWG . "&VEN=" . $VEN . "&PN=" . $PN . "&SN=" . $SN . "&STA=" . $STA . "&WP=" . $WP;
	...
	<table border="1" width="1024">
		...
		<tr>
			<td valign="top">
				...
				<form method="get" action="Parts_Receive_iFrames.php">
					...
					<table border="0" cellspace="1">
						...
						<tr>
							...
							<td valign="top">
								<font size="2">
									<input type="textbox" name="STA" value="<?php echo $STA; ?>">
								</font>
							</td>
						</tr>
					</table>
					...
					<input type="button" value="Reset Selection" onClick="window.location='Parts_Receive_iFrames.php';" style="width='200';">
				...
				<iframe id="PartsFrame" src="Parts_Receive.php?<?php echo $LINKVARS; ?>" border='0' frameborder='0' scrolling='auto' width="100%" height="440"></iframe>

				<br>
				<br>

				<center><input type="button" value="Download as CSV File" onclick="window.location='Parts_Receive_Download.php?<?php echo $LINKVARS; ?>';"></center>
			</td>
		</tr>
	</table>
