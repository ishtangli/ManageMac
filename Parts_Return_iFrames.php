	...
	<table border="1" width="1024">
		...
		<tr>
			<td valign="top">
				...
				<form method="get" action="Parts_Return_iFrames.php">
					...
					<input type="button" value="Reset Selection" onClick="window.location='Parts_Return_iFrames.php';" style="width='200';">
				...
				<iframe id="PartsFrame" src="Parts_Return.php?<?php echo $LINKVARS; ?>" border='0' frameborder='0' scrolling='auto' width="100%" height="440"></iframe>

				<br>
				<br>

				<center><input type="button" value="Download as CSV File" onclick="window.location='Parts_Return_Download.php?<?php echo $LINKVARS; ?>';"></center>
			</td>
		</tr>
	</table>
